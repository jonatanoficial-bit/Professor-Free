...
class _SettingsScreenState extends State<SettingsScreen> {
  final baseUrl = TextEditingController(text: 'http://localhost:8000');
  final token = TextEditingController(text: 'dev-token'); // MVP
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          TextField(controller: baseUrl, decoration: const InputDecoration(labelText: 'Backend URL')),
          const SizedBox(height: 10),
          TextField(controller: token, decoration: const InputDecoration(labelText: 'Token JWT (MVP dev-token)')),
          const SizedBox(height: 10),
          ...
          Text(
            'Nota: neste MVP o token é simples para teste. Em produção, o login será email+senha/OTP.',
