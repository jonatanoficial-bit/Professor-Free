    ...
    final ok = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            TextField(controller: schoolId, decoration: const InputDecoration(labelText: 'ID da escola (MVP)')),
    ...
    return FutureBuilder<String?>(
      ...
      builder: (context, snap) {
        ...
        return Scaffold(
          ...
          body: StreamBuilder(
            stream: widget.repo.watchClasses(teacherId),
            builder: (context, snap2) {
              final classes = snap2.data ?? [];
              return ListView(
                children: [
