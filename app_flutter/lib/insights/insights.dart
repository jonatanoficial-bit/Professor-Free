class InsightResult {
  final double trend; // >0 melhora, <0 piora
  final double projectionNext; // projeção de evolução próxima aula
  final String recommendation;
  InsightResult({required this.trend, required this.projectionNext, required this.recommendation});
}

/// IA integrada OFFLINE (MVP): usa evolução (-2..+2) e faz suavização exponencial.
/// Isso não depende de internet e dá recomendações rápidas.
